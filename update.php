...
if($_POST) {
	...
	if($errors == "")
	{
		$query = 'UPDATE tasks(checked,datetask,task) VALUES(:checked, :datetask, :task);';
...
<body>
	<div class="container">
		...
		<div class="content">
			<div class="phone">
			<span class="modif"><img src="img/update_icon.png" alt="Icône de modification"/></span>
			<form method="post" action="">
				<fieldset class="compte">
					<h3>Modifier une tâche</h3>
					<ol>
						<li id="add_task" class="decal">
						<label class="disappear" for="task">Modifier une tâche</label>
							<textarea id="task" class="area" name="username" placeholder="Modifier une tâche..."></textarea>
						</li>
						<li class="decal">
				...
				<input id="confirm_bottom" class="confirm_btn_bottom" name="confirm_bottom" type="submit" value="Modifier"/>
			</form>
			</div>
		</div>
	</div>
